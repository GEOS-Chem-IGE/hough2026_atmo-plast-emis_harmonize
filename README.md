...
The raw simulation outputs are archived at DOI:[10.5281/zenodo.22925451](https://doi.org/10.5281/zenodo.22925451) or can be generated by running the code at DOI:[10.5281/zenodo.22933613](https://doi.org/10.5281/zenodo.22933613). Place the `main/` and `alt/` output directories in `simulations/` like this:
