...
The atmospheric microplastic observations are included in this repository's [data](data/) folder

The raw simulation outputs are archived at DOI:[10.5281/zenodo.22925451](https://doi.org/10.5281/zenodo.22925451) or can be generated by running the code at DOI:[10.5281/zenodo.21066849](https://doi.org/10.5281/zenodo.21066849). Place the `main/` and `alt/` output directories in `simulations/` like this:
